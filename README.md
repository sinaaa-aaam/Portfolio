...
- 🔗 [More Details](https://github.com/Wazaaah/iBit_Soft_Project_.git)
...
- 🔗 [More Details](https://github.com/Delice782/DataSphere.git)

---

### 🔹 Digital Journal Application
A web-based journaling application that allows users to document their memories, reflections, and moments of gratitude.

- **Features:** Journal Entries, Collections, Reflections, Gratitude Journal, User Authentication, Profile Management
- **Technologies:** PHP, MySQL, HTML5/CSS3, JavaScript
- 🔗 [More Details](https://github.com/nana-ntim/memoire.git)

---

### 🔹 Health Risk Prediction Web Application
A machine learning-inspired web app that predicts health risk levels based on user data. Built a logic-based prediction engine using a JSON dataset, mimicking ML behavior without training a model.
...
A Java-based application simulating control and automation of smart devices including lights, alarms, locks, and cameras.

- **Design Patterns Used:** Strategy, Observer, Factory
- **Technologies:** Java
- 🔗 [More Details](https://github.com/sinaaa-aaam/SmartHomeController.git)
